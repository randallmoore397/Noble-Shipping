...
export default function ParcelTrackingPage() {
  ...
  const onSubmit = async (data: TrackingFormData) => {
    ...
    try {
      router.push(`/tracking/parcel/${data.tracking_number}`)
    } catch (error) {
              ...
              <div className="breadcrumb-content">
                <nav aria-label="breadcrumb">
                  <ol className="breadcrumb">
                    ...
                    <li className="breadcrumb-item"><Link href="/">Parcel</Link></li>
          ...
          <div className="row justify-content-center">
            <div className="col-xl-8 col-lg-10">
              <div className="tracking-id-info text-center">
                <p>Enter Tracking Code for Parcel <Link href="#">Tracking Number</Link></p>
