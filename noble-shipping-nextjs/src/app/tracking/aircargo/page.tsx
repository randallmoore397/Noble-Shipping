...
export default function AircargoTrackingPage() {
  ...
  const onSubmit = async (data: TrackingFormData) => {
    ...
    try {
      router.push(`/tracking/aircargo/${data.tracking_number}`)
    } catch (error) {
          ...
          <div className="row justify-content-center">
            <div className="col-xl-8 col-lg-10">
              <div className="tracking-id-info text-center">
                <p>Enter Tracking Code for Aircargo <Link href="#">Tracking Number</Link></p>
              ...
              <div className="col-lg-4 col-md-6">
                <div className="s-single-services mb-50">
                  <div className="services-thumb mb-25">
                    <Link href="#"><img src="/img/images/services_details_img.jpg" alt="img" style={{ height: '250px' }} /></Link>
                  </div>
