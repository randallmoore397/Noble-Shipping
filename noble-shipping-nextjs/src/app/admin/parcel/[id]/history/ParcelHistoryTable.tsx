...
export default function ParcelHistoryTable({ parcel }: ParcelHistoryTableProps) {
  return (
    <DataTable
      columns={[
        {
        ...
        },
        {
          ...
          cell: ({ row }) => (
            <Button variant="destructive" size="sm" asChild>
              <Link href={`/admin/parcel/history/${row.original.id}/edit`}>
      ...
      data={parcel.ParcelStatusHistory}
      searchKey="status"
